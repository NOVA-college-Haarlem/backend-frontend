...
- [ ] Geen enkele inline `style="..."` meer in de HTML
- [ ] Eén externe stylesheet, correct gelinkt
- [ ] Minimaal 3 classes gebruikt, elk op minstens 2 plekken
- [ ] Maximaal 1-2 IDs (alleen voor unieke elementen)
- [ ] Semantische structuur: `<header>`, `<main>` met `<section>`'s, `<footer>`
- [ ] Consistente padding/margin - geen elementen die tegen elkaar aan plakken
- [ ] Nette, ingesprongen code

### Bonus (Goed/Uitstekend)
- [ ] Hover-effecten op knoppen of links
...
- 15 min: kort plan maken - welke secties komt de pagina te bevatten?
- 65 min: zelfstandig bouwen (HTML-structuur eerst, dan CSS)

**Les 2 (90 min): Verder bouwen + peer review**
- 60 min: zelfstandig werken, focus op spacing en classes
- 20 min: peer review in tweetallen - check elkaars code in DevTools op inline styles en semantiek
- 10 min: laatste aanpassingen

**Les 3 (Presentatie/assessment)**
- Elke student laat de website 2-3 minuten zien: wat staat waar, welke classes gebruik je, waarom heb je voor deze structuur gekozen
