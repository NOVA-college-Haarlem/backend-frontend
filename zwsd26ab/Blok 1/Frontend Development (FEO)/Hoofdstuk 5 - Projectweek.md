## Hoofdstuk 5: PROJECT WEEK - Eerste Website

### Projectopdracht: "Mijn Hobby Pagina"

**Doel:** Pas toe wat je geleerd hebt in week 1-4
...
- Semantische HTML-structuur (`<header>`, `<main>`, `<footer>`, minimaal 1 `<section>`)
- Minimaal 1 `<h1>` en 2 `<h2>` headings
- Minimaal 3 paragrafen met tekst
- Minimaal 1 lijst (`<ul>` of `<ol>`) met minstens 3 items
