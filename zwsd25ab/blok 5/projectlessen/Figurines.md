...
Vocaloid-winkel "Vocaloid Vault" wil graag een applicatie om haar leden te kunnen registeren en bij te kunnen houden. Daarnaast willen ze de verschillende figurines (Hatsune Miku, Kagamine Rin & Len, Megurine Luka, KAITO, MEIKO, en andere Vocaloid-personages) die ze aanbieden dynamisch kunnen tonen op de site.
...
4. In de Windows Verkenner (File Explorer): verander de naam "docker-template" naar de naam van je project, bijvoorbeeld "fitness" of "figurines".
...
- **Member**: `member_number`, `loyalty_points`
...
- Alle figurines worden in één tabel vastgelegd `figurines`. Dit is één tabel met alle figurines die bekend zijn. 
- Een figurine-titel kan maar 1 keer voorkomen (uniek).
- Van een figurine wordt een `title`, `character`, `figure_type`, `manufacturer`, `price`, `image` en een `added_at` vastgelegd.
- Afbeeldingen dienen opgeslagen te worden op de webserver en op de juiste wijze dynamisch getoond te worden.
- Er is geen relatie tussen figurines en gebruiker

## Userstories

### Blok 3 (pas de kennis van blok 3 toe)
1. Als een bezoeker wil ik een overzicht zien van alle beschikbare figurines zodat ik snel kan bladeren door verschillende figurines
2. Als een bezoeker wil ik basisinformatie zien van elke figurine (titel, personage, thumbnail afbeelding) zodat ik een eerste indruk krijg zonder naar de detailpagina te hoeven gaan
3. Als bezoeker wil ik een website die mij meteen het gevoel geeft dat ik op een Vocaloid-figurinewinkel ben zodat ik direct weet dat ik op de juiste plek ben
4. Als een bezoeker wil ik op een figurine klikken zodat ik naar de detailpagina kan gaan voor meer informatie
5. Als een bezoeker wil ik kunnen filteren op type figuur (Nendoroid, Scale Figure, Figma, Prize Figure) zodat ik figurines kan vinden die passen bij mijn verzamelvoorkeur
6. Als een bezoeker wil ik kunnen filteren op prijsklasse (goedkoop, gemiddeld, duur) zodat ik figurines kan vinden die passen bij mijn budget
7. Als een bezoeker wil ik kunnen sorteren op prijs (van laag naar hoog of hoog naar laag) zodat ik figurines kan vinden die passen bij mijn budget
...
#### Backend
4. Als bezoeker wil ik kunnen zoeken door de database naar figurines op basis van titel, personage of type figuur
...
9. Als medewerker wil ik een overzicht zien van alle figurines in tabelvorm zodat ik weet welke figurines opgeslagen zijn
10. Als medewerker wil ik elke figurine in detail kunnen bekijken zodat ik de gegevens kan controleren
11. Als medewerker wil ik een nieuwe figurine kunnen opslaan zodat ik de database up-to-date houd
12. Bonus: Als medewerker wil ik een afbeelding kunnen uploaden bij het aanmaken van een figurine zodat de foto ook netjes opgeslagen wordt
